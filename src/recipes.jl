...
# NOTE: recipes for IMASdd.interferometer, interferometer__channel, and
# interferometer__channel___line_of_sight were removed: IMAS.jl defines
# recipes for the same types, and duplicate `apply_recipe` methods are a
# method-overwriting error during precompilation (e.g. sysimage builds)
# when both packages are loaded. IMAS.jl is the canonical home for these.
